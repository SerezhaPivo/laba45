...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        Action showCriticalValues = new AbstractAction("Show mod[f(x)]") {
            public void actionPerformed(ActionEvent event) {
    ...
    public static void main(String[] args) {
        ...
        {
            for(Double i = -20.0; i < 20; i += 0.2){

                dos.writeDouble(i);
                dos.writeDouble( -1 * Math.cos(Math.pow(i, 2)) - Math.log(Math.pow(i, 2) + 1) + 3);
            }
